        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAddress = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowVersion = table.Column<byte>(type: "INTEGER", nullable: true),
                    EndDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    WaterStations = table.Column<int>(type: "INTEGER", nullable: true),
                    SteamAccountName = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
